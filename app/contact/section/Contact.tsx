    ...
    return (
        <section className="w-full flex flex-col items-center bg-white justify-center gap-10 relative lg:p-8 xl:p-10 pb-10 ">
            ...
            <p className="max-w-[550px] text-center">
                Vous avez une vision, un projet ou un besoin stratégique ? Notre
                équipe est prête à vous accompagner avec rigueur et engagement.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center lg:px-10 xl:px-20 relative z-10">
                ...
                <div className="bg-black text-white px-10 py-10 flex flex-col gap-10">
                    ...
                    {informationData.map((item, id) => (
                        ...
                        >
                            <span className="bg-white p-2 h-fit rounded-full ">
                                {' '}
                                {item.icon}{' '}
                            </span>
                            {item.isLink ? (
                                <Link
                                    ...
                                    className="hover:cursor-pointer hover:text-secondary transition-colors underline font-light"
                                >
                                    {' '}
                                    <p> {item.text} </p>{' '}
                                </Link>
            ...
            <div className="h-[80%] w-[230px] absolute bg-secondary bottom-0 right-0 hidden lg:block">
                {' '}
            </div>
        </section>
    )
