...
const ServiceSectionFour = () => {
    return (
        <section className="bg-white lg:py-6 lg:px-0 p-4 flex flex-col lg:flex-row-reverse items-center relative">
            ...
            <div className="w-full lg:w-[55%] bg-white shadow-xl space-y-6 lg:p-16 p-4 z-30 lg:absolute lg:top-1/2 lg:left-0 lg:transform lg:-translate-y-1/2">
